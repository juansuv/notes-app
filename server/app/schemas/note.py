...
class NoteBase(BaseModel):
    title: str = Field(..., min_length=0, max_length=100, description="El título debe tener entre 3 y 100 caracteres.")
    content: str = Field(..., min_length=0, max_length=1000, description="El contenido debe tener entre 10 y 1000 caracteres.")
